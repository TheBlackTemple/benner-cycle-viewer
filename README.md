...
**[Try It Online](https://theblacktemple.org/arsenal/benner/)**

**[Download v0.2](https://github.com/TheBlackTemple/benner-cycle-viewer/releases/download/v0.2/benner.zip)** — no build needed, just open the HTML file.
...
No build step, no dependencies. [Grab the latest release](https://github.com/TheBlackTemple/benner-cycle-viewer/releases/download/v0.2/benner.zip) and open `index.html` in a browser — or clone the repo and do the same.
